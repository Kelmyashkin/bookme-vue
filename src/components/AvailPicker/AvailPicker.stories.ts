...
import AvailPicker from './AvailPicker.vue';
import AvailDay from '@/classes/availDay';

storiesOf('AvailPicker', module).add('Example', () => ({
  components: { AvailPicker },
  methods: {},
  data() {
    return {
      week: [
